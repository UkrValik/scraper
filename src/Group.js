...
function Group() {
	...
	this.week = async function(chatID) {
		...
		// ans[0][0][0].lesson[0] = 'Понеділок'
		// ans[0][1][0].lesson[0] = 'Вівторок'
		// ans[0][2][0].lesson[0] = 'Середа'
		// ans[0][3][0].lesson[0] = 'Четвер'
		// ans[0][4][0].lesson[0] = "П'ятниця"
		// ans[0][5][0].lesson[0] = 'Субота'
		return ans
	}
}
